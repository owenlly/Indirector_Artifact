...
%macro testcode 0               ; A multi-line macro executing any piece of test code.
    ...
    clflush [test_next_inst]
    mfence
    SERIALIZE

    %rep 5 * input_evict_ibp
        rdrand rdx
        and rdx, 1
...
start_test_ibranch:
    ...
    nop
    align 1<<6
    %rep 61 ; map mov to a different cacheline with the branch!
     nop
    %endrep
test_ibranch:
    jmp r10
...
SECTION .sec_eviction_dbranch exec
start_eviction_dbranch:
    %assign i 0
    %rep 12
        align 1<<15
        nop
...
start_eviction_ibranch:
    ...
    %rep 6
        ...
        lea r10, [eviction_itarget_0_%+ k]
        lea r9, [eviction_itarget_1_%+ k]
        cmp rdx, 1
        cmovz r10, r9
        mfence
    ...
    eviction_ibranch_%+ k:
        ...
        %rep 512
         nop
        %endrep
    eviction_itarget_0_%+ k:
        %rep 512
         nop
        %endrep
    eviction_itarget_1_%+ k:
        %rep 512
         nop
        %endrep
    %assign k k+1
