...
protected:
    CMSRInOutQue queue1[512];                 // que of MSR commands to do by StartCounters()
    CMSRInOutQue queue2[512];                 // que of MSR commands to do by StopCounters()
